...
(function () {
  ...
  var DICT = {
    ...
    ru: {
      ...
      't.actions.editPlayers': '✏️ Изменить игроков',
      'setup.btn.saveEdit': '💾 Сохранить изменения',
    ...
    en: {
      ...
      't.actions.editPlayers': '✏️ Edit players',
      'setup.btn.saveEdit': '💾 Save changes',
    ...
    es: {
      ...
      't.actions.editPlayers': '✏️ Editar jugadores',
      'setup.btn.saveEdit': '💾 Guardar cambios',
